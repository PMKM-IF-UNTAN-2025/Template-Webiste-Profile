          ...
          <div className="card-body p-0">
            <nav className="navbar navbar-expand-lg p-2">
              <div className="container px-2">
                {/* Brand/Logo */}
                <Link className="navbar-brand text-uppercase" href="/" onClick={() => setIsMenuOpen(false)}>
                ...
                <div className={`collapse navbar-collapse py-2 ${isMenuOpen ? 'show' : ''}`} id="navbarNav">
                  <ul className="navbar-nav ms-auto text-center align-items-center">
                    ...
                    <li className="nav-item mx-1">
                      <button 
                        ...
                        onClick={() => handleSectionNavigation('visi-misi')}
                      >
                        Tentang
                      </button>
                    </li>
                  ...
                  <ul className="navbar-nav">
                    <li className="nav-item">
                      <div className="theme-toggle d-flex justify-content-center align-items-center gap-2 px-3">
                        {/* Light Mode Icon */}
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 21 21" className="text-muted">
                        ...
                        {/* Dark Mode Icon */}
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" className="text-muted">
